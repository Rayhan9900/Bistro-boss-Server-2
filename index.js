...
async function run() {
    try {
        ...
        const verifyAdmin = async (req, res, next) => {
            ...
            if (!isAdmin) {
                return res.status403.send({ message: 'forbidden access' })
            };
            next()
        }
        ...
        app.post('/users', async (req, res) => {
            ...
            if (existingUser) {
                return res.send({ message: 'usre already exists', insertedId: null })
            }
        ...
        app.patch('/menu/:id', async (req, res) => {
            ...
            const result = await menuCollection.updateOne(filter, updateDo)
            res.send(result);
